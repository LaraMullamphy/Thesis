...
\noindent
A "Go-Pro" camera was used to video the notch of each specimen during loading. The camera was connected to a magnetic lever arm which would magnetically attach to the MTS machine. This allowed the camera to be moved to the optimal position, to capture the notch failure, for each experiment.
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.3]{Notch_Angles}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\includegraphics[scale=0.4]{Circular_Notch_Angles}
	\end{center}
...
\noindent
The timber used for testing was spotted gum (corymbia maculata) timber, as it a hardwood that is commonly used in Queensland bridges that are currently being utilised. The properties and characteristics of spotted gum timber are given in Table \ref{tab:spotty} \cite{elsener_material_2014,hopewell_spotted_2004}. All specimens will be unseasoned and green (have a water content greater than 12\%).
...
Throughout all rectangular experiments, there was a definite pattern in the types of failure that occurred; first a crack initiated from the notch corner, which propagated to roughly the centre of the beam, then ultimate failure occurred in either shear or flexure or both.  
...
\vspace*{\baselineskip}
\noindent Table Showing water content and failure types \par
...
\begin{center}
	\begin{tabularx}{\textwidth}{|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|} 
		...
		\textbf{Notch Angle Slope} & \textbf{Specimen No.} & \textbf{Water Content (\%)} & \textbf{Location of Initial Failure}\tabularnewline [0.5ex]
		\hline
		
		1:0 & 1 &  & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:0 & 2 &  & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:0 & 3 &  & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:0 & 4 & 19 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		
		1:2 & 1 & 14 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 2 & 16 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 3 & 16 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 4 & 13 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		
		1:4 & 1 & 19 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 2 & 15 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 3 & 18 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 4 & 18 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		
	\end{tabularx}
\end{center}

It should be noted that the water contents for rectangular specimens 1, 2 and 3 of 1:0 notch were not taken.
...
\begin{center}
	\begin{tabularx}{\textwidth}{|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|} 
		...
		1:0 & 1 & 22 & Cracked propagated from existing crack at opposite end, then cracked at notch corner  \tabularnewline [0.5ex]
		\hline
		1:0 & 2 & 21 & Cracked at notch corner  \tabularnewline [0.5ex]
		\hline
		1:0 & 3 & 24 & Cracked at notch corner  \tabularnewline [0.5ex]
		\hline
		1:0 & 4 & 26 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		
		1:2 & 1 & 23 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 2 & 30 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 3 & 22 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:2 & 4 & 29 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		
		1:4 & 1 & 24 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 2 & 22 & Cracked propagated half way down chamfer, then cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 3 & 27 & Cracked at notch corner \tabularnewline [0.5ex]
		\hline
		1:4 & 4 & 23 & Full member failed (notch didn't fail) \tabularnewline [0.5ex]
		\hline
