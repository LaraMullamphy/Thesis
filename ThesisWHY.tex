...
\newcommand*{\titleGP}{\begingroup % Create the command for including the title page in the document
	...
	{\Huge EG4012\\ Civil Engineering\\ [0.3\baselineskip] } % Title
	
	\vspace*{6\baselineskip} % Whitespace between location/year and editors
	
	{\Huge \bf{THE EFFECTS OF NOTCHING ON RECTANGULAR AND ROUND TIMBER GIRDERS}\\ [0.3\baselineskip] } % Title
	...
	\vfill % Whitespace between editor names and publisher logo
		...
		7 October 2016\par % Location and year
...
\begin{center}
	\begin{tabularx}{\textwidth}{|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|>{\centering}X|}	
		...
		\multicolumn{2}{|c|}{Strength Group (AS1720)}&  & S2 & SD2  \tabularnewline [0.5ex] 
		\hline
		
		\multicolumn{2}{|c|}{F-Grade (AS1720)}&  & F14 & F22  \tabularnewline [0.5ex] 
		\hline
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Rect_10_Def}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Rect_10_Centre}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Rect_10_Z_Far}}
		\fbox{\includegraphics[scale=0.55]{Rect_10_Z_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Rect_10_Y_Far}}
		\fbox{\includegraphics[scale=0.55]{Rect_10_Y_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Rect_12_Z_Far}}
		\fbox{\includegraphics[scale=0.55]{Rect_12_Z_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Rect_14_Def}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Rect_14_Y_Far}}
		\fbox{\includegraphics[scale=0.55]{Rect_14_Y_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Round_10_def}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Round_10_Centre}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Round_10_Z_Far}}
		\fbox{\includegraphics[scale=0.55]{Round_10_Z_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Round_10_Y_Far}}
		\fbox{\includegraphics[scale=0.55]{Round_10_Y_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.7]{Round_12_Centre}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Round_12_Y_Far}}
		\fbox{\includegraphics[scale=0.55]{Round_12_Y_Near}}
	\end{center}
...
\begin{figure}[h]
	\begin{center}
		\fbox{\includegraphics[scale=0.55]{Round_14_Y_Far}}
		\fbox{\includegraphics[scale=0.55]{Round_14_Y_Near}}
	\end{center}
